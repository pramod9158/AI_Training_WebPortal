...
export function ModuleClient() {
  ...
  return (
    <div className="min-h-screen py-6 sm:py-12 px-3 sm:px-6 lg:px-8 max-w-5xl mx-auto space-y-6 sm:space-y-8">
      ...
      <Link
        href="/curriculum"
        className="inline-flex items-center space-x-2 text-xs font-mono text-slate-400 hover:text-cyan-400 transition-colors focus-visible:ring-2 focus-visible:ring-sky-500 focus-visible:outline-none rounded"
      >
