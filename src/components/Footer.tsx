...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-slate-50 dark:bg-[#070A12] border-t border-slate-200 dark:border-slate-800/80 pt-10 pb-8 text-slate-600 dark:text-slate-400 text-sm transition-colors">
      ...
      {isContactModalOpen && (
        <div 
          className="fixed inset-0 z-50 overflow-y-auto bg-black/75 backdrop-blur-sm p-4 flex items-center justify-center min-h-screen animate-in fade-in duration-200"
          onClick={handleCloseModal}
        >
          <div 
            className="relative my-auto w-full max-w-lg bg-white dark:bg-[#0D121F] border border-slate-200 dark:border-slate-800 rounded-3xl shadow-2xl overflow-hidden p-6 sm:p-8"
          ...
          >
            ...
            {/* Modal Header */}
            <div className="text-center mb-6 space-y-1.5 pr-6">
              ...
              <div className="py-8 text-center space-y-4 animate-in zoom-in-95 duration-200">
                ...
                <div className="pt-2 flex items-center justify-center space-x-3">
                  <button
                    ...
                    className="px-4 py-2 rounded-xl text-xs font-bold text-[#5850EC] dark:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-indigo-950/40 transition-colors"
                  >
              ...
              <form onSubmit={handleSubmit} className="space-y-3.5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-white placeholder-slate-400 text-xs focus:outline-none focus:ring-2 focus:ring-[#5850EC]"
                    />
                  </div>
                  <div>
                    <label className="block text-xs font-semibold text-slate-700 dark:text-slate-300 mb-1">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-3 py-2 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-white placeholder-slate-400 text-xs focus:outline-none focus:ring-2 focus:ring-[#5850EC] resize-none"
                  />
                </div>
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center space-x-2 py-3 px-4 rounded-xl bg-[#5850EC] hover:bg-[#4338CA] active:scale-[0.99] disabled:opacity-50 text-white !text-white font-extrabold text-xs sm:text-sm shadow-md transition-all cursor-pointer mt-1"
