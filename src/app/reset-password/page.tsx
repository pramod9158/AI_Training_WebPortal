    ...
    return (
      <div className="w-full max-w-md bg-white dark:bg-[#0D121F] border-2 border-emerald-300 dark:border-emerald-500/40 rounded-3xl p-8 shadow-2xl space-y-6 text-center animate-in fade-in duration-300">
        ...
        <div className="pt-2">
          <Link
            href="/login"
            className="w-full py-3 rounded-xl bg-slate-900 hover:bg-slate-800 text-white dark:bg-white dark:text-slate-900 dark:hover:bg-slate-100 font-bold text-sm transition-all flex items-center justify-center space-x-2 shadow-sm"
          >
